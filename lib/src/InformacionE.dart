...
class Evaluadas extends ModalRoute<void> {
  @override
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          'Descripcion del requerimiento: Quiero Informacion',
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.black,
                          ),
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          'Comentario: No es muy buen curso, gracias',
                          style: TextStyle(
                            fontSize: 12,
                            color: Colors.black,
                          ),
